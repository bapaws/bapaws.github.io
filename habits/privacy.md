...
7. 订阅与支付信息：当您选择订阅本应用的付费服务时，我们可能会收集您的支付信息，包括但不限于支付方式、交易记录、订阅状态等。这些信息将用于处理您的订阅请求、管理您的订阅状态，以及提供客户支持服务。请注意，具体的支付处理由第三方支付服务提供商（如Apple App Store、Google Play Store等）负责，我们将不会直接处理或存储您的支付卡信息。

8. 自动续费说明：如果您选择订阅本应用的付费服务，您的订阅将自动续费，除非您在订阅期结束前至少24小时取消自动续费。您可以在设备设置中管理您的订阅设置，包括查看、修改或取消自动续费。我们将在每次续费前通过应用内通知或电子邮件等方式提醒您即将进行的续费操作。

9. 用户自主选择权：您可以根据自己的意愿选择是否提供个人信息。但请注意，如果您选择不提供某些必要的个人信息，可能会影响您使用本应用的部分功能和服务。
...
4. 支付服务提供商：本应用的订阅和支付功能由第三方支付服务提供商（如Apple App Store、Google Play Store等）处理。这些服务提供商将收集和处理您的支付信息，包括支付卡信息、账单地址等。我们建议您在使用这些支付服务之前，仔细阅读相关支付服务提供商的隐私政策和条款。

5. 与其他服务的互通：本应用可能与其他服务进行互通，以提供更全面的功能和服务。当您使用与本应用互通的其他服务时，请您仔细阅读并了解相关服务的隐私政策和行为。
