...
Bapaws ("us", "we", or "our") operates the Chat Answer mobile application (hereinafter referred to as the "Service").
...
* Service
    ...
    Service is the Chat Answer mobile application operated by Bapaws
